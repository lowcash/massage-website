...
export default function Services() {
  return (
    <section id={SECTIONS[0].id} className='mx-auto max-w-5xl bg-gray-50'>
...
const SERVICES = [
  {
    title: 'Thajská masáž nohou',
    description: 'Tradiční thajská technika uvolňující nohy a chodidla, zmírňuje únavu a podporuje cirkulaci.',
    duration: '75 / 105 min - od 850,-',
    icon: ICON_1,
  },
  {
    title: 'Medová detoxikační masáž',
    description: 'TPoužití teplého medu k pročištění pokožky a detoxikaci těla, napomáhá relaxaci a uvolnění.',
    duration: '60 / 90 min - od 700,-',
    icon: ICON_2,
  },
  {
    title: 'Hloubková masáž (Deep tissue massage)',
    description: 'Intenzivní technika zaměřená na hluboké svaly, uvolňuje napětí a zlepšuje pružnost tkání.',
    duration: '75 / 105 min - od 850,-',
    icon: ICON_3,
  },
  {
    title: 'Ošetření spoušťových bodů',
    description: 'Cílený tlak na bolestivé body uvolňuje svalovou ztuhlost a pomáhá při chronických bolestech.',
    duration: '60 / 90 min - od 700,-',
    icon: ICON_1,
  },
  {
    title: 'Náprava a korekce metodou z MBS s prvky Chiropraxe',
    description: 'Jemná manuální technika upravuje pohybový aparát, zmírňuje bolesti zad a zlepšuje držení těla.',
    duration: '60 / 90 min - od 900,-',
    icon: ICON_2,
  },
  {
    title: 'Protimigrénová masáž',
    description: 'Šetrné hmaty na šíji a hlavě zmírňují migrény, napětí i stres.',
    duration: '45 min - od 600,-',
    icon: ICON_3,
  },
  {
    title: 'Spinální masáž',
    description: 'Masáž podél páteře uvolňuje svaly, napomáhá regeneraci a podporuje správné držení těla.',
    duration: '60 / 90 min - od 750,-',
    icon: ICON_1,
  },
  {
    title: 'Baby masáž',
    description: 'Jemná masáž pro děti a miminka podporující psychomotorický vývoj i klidný spánek.',
    duration: '30 min - od 400,-',
    icon: ICON_2,
  },
  {
    title: 'Kineziotaping',
    description: 'Aplikace pružných pásek pro úlevu, zpevnění svalů a podporu regenerace.',
    duration: '20 / 30 min - od 250,-',
    icon: ICON_3,
  },
  {
    title: 'Těhotenská masáž',
    description: 'Šetrná masáž pro těhotné ulevující od bolesti zad, otoků i napětí.',
    duration: '60 min - od 700,-',
    icon: ICON_1,
  },
]
