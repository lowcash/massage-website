                  ...
                  <div className="p-4 md:p-8 flex flex-col justify-between h-full">
                    ...
                    <div className="text-center mb-3 md:mb-4">
                      ...
                      <h3
                        ...
                        style={{ fontFamily: 'Dancing Script', fontSize: 'clamp(1.8rem, 5vw, 2.2rem)' }}
                      >
                        Dárkové poukazy
                      </h3>
                      <p className="text-[#666666] leading-relaxed text-base md:text-base px-4 md:px-10" style={{ wordSpacing: '0.1em' }} lang="cs">
                    ...
                    <div className="flex flex-col gap-2 md:gap-3">
                      ...
                      >
                        ...
                        <span style={{ fontFamily: 'Dancing Script', fontSize: 'clamp(1.05rem, 3vw, 1.15rem)' }}>
