  ...
  return (
    <section id="services" className="py-32 px-6 md:px-16 bg-linear-to-b from-white via-[#fef8fb] to-white">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          {formatCzechText("Jak Vám můžu pomoci?")}
        </motion.h2>
        ...
        >
          {formatCzechText("Nabízím širokou škálu masáží a terapií přizpůsobených vašim individuálním potřebám pro dosažení harmonie těla i mysli.")}
        </motion.p>
              ...
              >
                <div className="flex items-start gap-5 mb-5">
                  ...
                  <div className="flex-1">
                    ...
                    >
                      {formatCzechText(service.name)}
                    </h3>
                  </div>
                </div>
                <p className="text-[#666666] mb-4 leading-relaxed">
                  {formatCzechText(service.description)}
                </p>
