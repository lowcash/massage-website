...
export default function Hero() {
  return (
    <section id='hero' className='relative flex min-h-svh items-center justify-center overflow-hidden'>
      ...
      <div className='animate-in fade-in slide-in-from-bottom-4 relative z-20 mx-auto flex w-full max-w-5xl flex-col items-center gap-6 px-6 pt-16 text-center text-white duration-700 md:gap-8'>
